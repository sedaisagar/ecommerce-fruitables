...
class DynamicPagesList(generic.ListView):
    ...
    queryset = DynamicPages.objects.filter()
    ...
    template_name = "admin-panel/pages/pages.html"
    ordering = ["id"]
    paginate_by = 10
    ...
    def get_queryset(self):
        ...
        #     return Pages.objects.filter(parent__pk=parent_pk)
...
class DynamicPagesDetail(generic.DetailView):
    ...
    model = DynamicPages
    template_name = "admin-panel/pages/pages-detail.html"
...
class DynamicPagesDelete(generic.DeleteView):
    ...
    def get_context_data(self, **kwargs):
        ...
        data.update(
            title = "Delete This Pages Object ? ",
            show_object = True,
            redirect_url=self.success_url,
        )
